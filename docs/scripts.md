...
| `fm-wake-drain.sh`       | Present and acknowledge the current actor's claimed wake rows alongside the wake brief and status, outcome-backstop, decision, divergence, recovery, and supervision checks |
